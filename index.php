...
<head>
  ...
  <title>Gwitalmeze Carrelage</title>
...
<body data-spy="scroll" data-target="#main-navbar">
  ...
  <div class="body">
      ...
      <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="index.html">Gwitalmeze Carrelage</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                <a class="page-scroll" href="#about-section">A propos</a>
              </li>
              <li>
    ...
    <section id="text-carousel-intro-section" class="parallax" data-stellar-background-ratio="0.5" style="background-image: url(img/slider-bg-cuis.jpg)">
      <div class="container">
    ...
    <section id="about-section" class="page bg-style1">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-9">
                ...
                <p>
                  Inspired by nature, follow technology, appreciate the
                  classics. You can build modern & professional websites with
                  Unika. The possibilities are just endless.
                </p>
              </div>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0">
                  <span class="rotate-box-icon"><i class="fa-brands fa-instagram"></i></span>
                  <div class="rotate-box-info">
      ...
      <!-- <section id="testimonial-section">
        <div
          ...
          class="testimonial text-white parallax"
            ...
            <div class="testimonial-inner center-block text-center">
              <div id="owl-testimonial" class="owl-carousel">
                <div class="item">
                  <blockquote>
                    <p>
                      "This was my first experience with that team and
                      outperformed my expectation! They know there stuff and I
                      highly recommend them! A+++".
                    </p>
                    <footer>
                      <cite title="Source Title">Daryl Hodgeman</cite>
                    </footer>
                  </blockquote>
                </div>
                <div class="item">
                ...
                <div class="portfoloi_content_area">
                  <div class="portfolio_menu" id="filters">
                    <ul>
                      ...
                      <li>
                        <a href="#porfolio_menu" data-filter=".webDesign">web design</a>
                      </li>
                      <li>
                        <a href="#porfolio_menu" data-filter=".appsDevelopment">apps development</a>
                      </li>
                      <li>
                        <a href="#porfolio_menu" data-filter=".GraphicDesign">graphic design</a>
                      </li>
                      <li>
                        <a href="#porfolio_menu" data-filter=".responsive">responsive</a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="portfolio_content">
                    <div class="row" id="portfolio">
                      ...
                      <div class="col-xs-12 col-sm-4 webDesign websites">
                        <div class="portfolio_single_content">
                          <img src="IMG_5428.jpg" alt="title" />
                          <div>
      ...
      <!-- <section id="counter-section">
        <div
          id="counter-up-trigger"
          class="counter-up text-white parallax"
          data-stellar-background-ratio="0.5"
      ...
      <!-- <section id="prices-section" class="page">
        ...
        <div class="prices">
          <div class="container">
            <div class="row">
              <div
                class="price-box col-sm-6 col-md-3 wow flipInY"
                data-wow-delay="0.3s"
              >
              ...
              <div
                class="price-box col-sm-6 price-box-featured col-md-3 wow flipInY"
                data-wow-delay="0.7s"
              >
                <div class="panel panel-default">
                  <div class="panel-heading text-center">
    ...
    <section id="social-section">
      ...
      <div class="container">
        <ul class="social-list">
          <li>
            <a href="#" class="rotate-box-1 square-icon text-center wow zoomIn" data-wow-delay="0.3s"><span class="rotate-box-icon"><i class="fa fa-facebook"></i></span></a>
          </li>
          <li>
            <a href="#" class="rotate-box-1 square-icon text-center wow zoomIn" data-wow-delay="0.4s"><span class="rotate-box-icon"><i class="fa fa-twitter"></i></span></a>
          </li>
          <!-- <li>
              <a
                href="#"
                ...
                ><span class="rotate-box-icon"
                  ><i class="fa fa-pinterest-p"></i></span
              ></a>
            </li> 
            <li>
              <a
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="contact-info">
                ...
                <ul class="contact-address">
                  <li>
                    <i class="fa fa-map-marker fa-lg"></i>&nbsp; 20 rue
                    Guillaume de Kersimon,<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    29830 Ploudalmézeau,<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    France
                  </li>
                  <li><i class="fa fa-phone"></i>&nbsp; 06 73 00 67 57</li>
              ...
              <div id="map">
                <script>
                  var map = L.map("map").setView(
                    [48.53580264943112, -4.653311260339878],
                    14
                  );
                  L.tileLayer(
                  ...
                  var marker = L.marker([48.5356063, -4.656073]).addTo(map);
                </script>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="contact-form">
                <h4>Demander votre devis</h4>
                <form role="form" action="./form_devis.php" method="post">
                  <div class="form-group">
                    <input type="text" class="form-control input-lg" placeholder="Votre nom" name="nom" required />
                  </div>
                  <div class="form-group">
                    <input type="email" class="form-control input-lg" placeholder="E-mail" name="email" required />
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control input-lg" placeholder="Sujet" name="sujet" required />
                  </div>
                  <div class="form-group">
